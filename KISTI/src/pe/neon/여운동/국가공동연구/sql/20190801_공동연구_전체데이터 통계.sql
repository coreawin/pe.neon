...
/*
  @coreawin 201908 작업 : 논문 ID, 논문의 연도, 대분류, 국가 정보, 피인용 수 수집
...
SELECT /*+ PARALLEL (4) */  DOC_INFO.EID, DOC_INFO.PUBLICATION_YEAR, LARGE_ASJC.L_ASJC_CODE, DECODE(NVL(AFF_INFO.COUNTRY_CODE, 'NONE'), '.', 'NONE', NVL(AFF_INFO.COUNTRY_CODE, 'NONE')) AS COUNTRY_CODE, DOC_INFO.CIT_COUNT
FROM NYEO2019_SCOPUS_DOCUMENT DOC_INFO
LEFT OUTER JOIN(
...
COMMENT ON TABLE NYEO2019_SCOPUS_UNIQ_CT_EID IS '@coreawin 201908 작업 : 논문 ID, 논문의 연도, 대분류, 국가 정보, 피인용 수 수집, SCOPUS 기관의 국가정보 수집시 논문 1건의 기관의 국가정보의 중복을 베제하고 수집.';
